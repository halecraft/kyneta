...
import type { Value, Substitution } from '../../src/datalog/types.js';
import {
  EMPTY_SUBSTITUTION,
  extendSubstitution,
  resolveTerm,
...
describe('valuesEqual', () => {
  ...
  it('Uint8Array compares by content', () => {
    expect(valuesEqual(new Uint8Array([1, 2, 3]), new Uint8Array([1, 2, 3]))).toBe(true);
    expect(valuesEqual(new Uint8Array([1, 2, 3]), new Uint8Array([1, 2, 4]))).toBe(false);
    expect(valuesEqual(new Uint8Array([1, 2]), new Uint8Array([1, 2, 3]))).toBe(false);
...
describe('compareValues', () => {
  ...
  it('compares Uint8Array lexicographically', () => {
    expect(compareValues(new Uint8Array([1, 2]), new Uint8Array([1, 3]))).toBeLessThan(0);
