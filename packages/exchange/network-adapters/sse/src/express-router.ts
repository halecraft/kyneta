...
//
// Creates Express routes that integrate with SseServerAdapter:
...
import type { SseServerAdapter } from "./server-adapter.js"
 ...
 *
 * @param adapter The SseServerAdapter instance
