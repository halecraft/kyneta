...
//   import { createBunWebsocketHandlers } from "@kyneta/adapter-websocket/bun"
//
 ...
 */
export class WebsocketServerAdapter extends Adapter<PeerId> {
  #connections = new Map<PeerId, WebsocketConnection>()
  readonly #fragmentThreshold: number

  constructor(options?: WebsocketServerAdapterOptions) {
